...
The scripts folder includes scripts for 3 analyses: k-means clustering, TreeCluster_analysis, and Construct colored tree with GCL.  
...
The scripts for Construct colored tree with GCL written by Ruby, but R also requires running using sqlite3 database, a Newick file, and cluster info output from TreeCluster analysis. Rackfile can be used for running analysis.  
